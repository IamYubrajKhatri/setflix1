...
function AdminDashboard() {
  ...
  const [image, setImage] = useState(null); // For thumbnail upload
  const [type, setType] = useState('entertainment'); // Price selection
  ...
  const handleVideoUpload = async (e) => {
    ...
    formData.append('image', image || ''); // Optional thumbnail
