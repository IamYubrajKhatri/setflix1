...
// Filter movies based on price
  const filterDataA=movies.filter((data)=> data.type === "entertainment");
  const filterDataB=movies.filter((data)=> data.type === "learning");
  ...
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 bg-white'>
      <div>
      <h2 className='mt-20 text-center text-2xl font-bold '>Entertainment</h2>
      <hr />
      <div className=''>
      <Slider {...settings}>
      ...
      <br />
      <div>
      <h2 className=' text-center text-2xl font-bold '>Learning</h2>
      <hr />
      <div className=''>
      <Slider {...settings}>
